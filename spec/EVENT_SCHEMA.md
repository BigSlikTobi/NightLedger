...
- `meta.workflow`
- `meta.step`
- `prev_hash` (stored/projection integrity field)
- `hash` (stored/projection integrity field)
...
- `prev_hash` + `hash` are generated by append-only storage/projection paths as
  tamper-evident integrity metadata (not caller-provided on ingest)
